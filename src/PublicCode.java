...
// PublicCode.java - Assignment 3
// Author: Leala Darby
// Student Number: 3279478
// Date: 1/11/2019

/**
 * This PublicCode class contains several variables that are considered 'always' known to both the client and the server,
 * eg. parameters given in the assignment specs, as well as various methods that are known and used such as fast modular
 * exponentiation, the creation of a SHA256 hash, etc.
 */
